docker run --rm  -v C:\projects\Relewise\relewise-sdk-php:/local openapitools/openapi-generator-cli generate -i https://api.relewise.com/public/swagger.json -g php -o /local/out --additional-properties=legacyDiscriminatorBehavior=False --additional-properties=modern --additional-properties=invokerPackage='Relewise\Models' --additional-properties=variableNamingConvention='camelCase' --global-property models
