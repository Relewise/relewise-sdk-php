...
class SaveAdvertisersResponse extends AdvertiserstringSaveEntitiesResponse
{
    ...
    {
        $result = AdvertiserstringSaveEntitiesResponse::hydrateBase(new SaveAdvertisersResponse(), $arr);
        return $result;
    }
