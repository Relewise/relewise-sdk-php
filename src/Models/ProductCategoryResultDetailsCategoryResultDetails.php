...
abstract class ProductCategoryResultDetailsCategoryResultDetails implements JsonSerializable
{
    ...
    {
        $result = array();
        $result["typeDefinition"] = "Relewise.Client.DataTypes.CategoryResultDetails`1[[Relewise.Client.DataTypes.ProductCategoryResultDetails, Relewise.Client, Version=1.156.0.0, Culture=neutral, PublicKeyToken=null]], Relewise.Client";
