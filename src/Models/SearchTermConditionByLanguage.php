...
class SearchTermConditionByLanguage extends SearchTermCondition
{
    public string $typeDefinition = "Relewise.Client.DataTypes.Search.Rules.SearchTermConditionByLanguage, Relewise.Client";
    public Language $language;
    
    public static function create(Language $language) : SearchTermConditionByLanguage
    {
        $result = new SearchTermConditionByLanguage();
        $result->language = $language;
        $result->negated = false;
        return $result;
    }
    
    public static function hydrate(array $arr) : SearchTermConditionByLanguage
    {
        $result = new SearchTermConditionByLanguage();
