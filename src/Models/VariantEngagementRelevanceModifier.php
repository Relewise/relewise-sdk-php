...
/** A RelevanceModifier that multiplies the relevance of variants based on the current user's engagement data. */
class VariantEngagementRelevanceModifier extends RelevanceModifier
{
    public string $typeDefinition = "Relewise.Client.Requests.RelevanceModifiers.VariantEngagementRelevanceModifier, Relewise.Client";
    ...
    /**
     * Creates a new VariantEngagementRelevanceModifier.
     ...
     */
    public static function create(?ProductEngagementDataSentimentKind $sentiment, ?bool $isFavorite, float $multiplyWeightBy = 1, bool $negated = false) : VariantEngagementRelevanceModifier
    {
        $result = new VariantEngagementRelevanceModifier();
    ...
    public static function hydrate(array $arr) : VariantEngagementRelevanceModifier
    {
        $result = RelevanceModifier::hydrateBase(new VariantEngagementRelevanceModifier(), $arr);
