...
class AbandonedSearchTriggerConfiguration extends AbandonedSearchTriggerResultTriggerConfiguration
{
    ...
    /**
     * Sets searchTypesInPrioritizedOrder to a new value.
    ...
    /**
     * Sets searchTypesInPrioritizedOrder to a new value from an array.
     * @param SearchType[] $searchTypesInPrioritizedOrder new value.
     */
    ...
    /**
     * Sets searchTermCondition to a new value.
     * @param ?SearchTermCondition $searchTermCondition new value.
     */
