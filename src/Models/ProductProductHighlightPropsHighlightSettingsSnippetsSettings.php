...
class ProductProductHighlightPropsHighlightSettingsSnippetsSettings
{
    ...
    public static function create() : ProductProductHighlightPropsHighlightSettingsSnippetsSettings
    {
        $result = new ProductProductHighlightPropsHighlightSettingsSnippetsSettings();
        return $result;
    }
    
    public static function hydrate(array $arr) : ProductProductHighlightPropsHighlightSettingsSnippetsSettings
    {
        $result = new ProductProductHighlightPropsHighlightSettingsSnippetsSettings();
