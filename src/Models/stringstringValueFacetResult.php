...
abstract class stringstringValueFacetResult extends FacetResult
{
    public string $typeDefinition = "Relewise.Client.DataTypes.Search.Facets.Result.ValueFacetResult`2[[System.String, System.Private.CoreLib, Version=8.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e],[System.String, System.Private.CoreLib, Version=8.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], Relewise.Client";
    ...
    public static function hydrateBase(mixed $result, array $arr)
    {
        ...
        if (array_key_exists("available", $arr))
        {
            ...
            {
                array_push($result->available, stringAvailableFacetValue::hydrate($value));
            }
        }
        return $result;
    }
