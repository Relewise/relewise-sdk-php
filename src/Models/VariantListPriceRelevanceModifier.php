...
class VariantListPriceRelevanceModifier extends RelevanceModifier
{
     ...
     * @param ?floatRange $range The range of list prices that this  will distinguish on.
     ...
     * @param bool $negated Determines whether this  should apply to all the Variants that aren't contained within the specific  instead.
     */
