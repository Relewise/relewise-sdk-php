...
class AdvertisersResponse extends AdvertiserstringAdvertiserEntityStateEntityResponse
{
    ...
    {
        $result = AdvertiserstringAdvertiserEntityStateEntityResponse::hydrateBase(new AdvertisersResponse(), $arr);
        return $result;
    }
