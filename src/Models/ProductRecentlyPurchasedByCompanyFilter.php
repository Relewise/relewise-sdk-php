...
class ProductRecentlyPurchasedByCompanyFilter extends Filter implements JsonSerializable
{
    ...
    {
        $result = array();
        $result["typeDefinition"] = "Relewise.Client.Requests.Filters.ProductRecentlyPurchasedByCompanyFilter, Relewise.Client";
