...
/** The search request shape establishes language-currency context with search filters, optional user info. <para>Defines Language. Currency pair, as well as Filters (both PostFilters).</para> <example>Products search is done through - ProductSearchRequest</example> <example>Content search is done through - ContentSearchRequest</example> <example>Search term prediction is done through - SearchTermPredictionRequest</example> */
