...
class ProductProductHighlightPropsHighlightSettingsLimits
{
    ...
    {
        $result = new ProductProductHighlightPropsHighlightSettingsLimits();
        return $result;
    }
    
    public static function hydrate(array $arr) : ProductProductHighlightPropsHighlightSettingsLimits
    {
        $result = new ProductProductHighlightPropsHighlightSettingsLimits();
